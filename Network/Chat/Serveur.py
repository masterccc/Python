...
class Serveur(Tkinter.Tk): # héritage de la classe Tkinter.Tk -> fenêtre python
    ...
    def __init__(self):
        ...
        self.title("Tchat - Serveur") #titre de la fenêtre
        ...
        try:
            ...
            self.socket_client, self.addr_client = self.socket_server.accept()
